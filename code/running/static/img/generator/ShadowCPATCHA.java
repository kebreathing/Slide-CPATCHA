...
public class ShadowCPATCHA {
	...
	public static void shadowGeneratorDir(String dirPathIn,
		...
		System.out.println("Pay Attention Please:\n" +
			"When you are the first time to use this, check the path written in Config.java,\n" +
			"then go and create the directories or input your customed path with Parameters.");
	...
	*/
	public static void shadowGenerator(String filePathIn,
		...
		if(filePathOutShadow == null || filePathOutShadow.length() == 0)
			filePathOutShadow = Config.shadowPath;
		if(filePathOutPiece == null || filePathOutPiece.length() == 0)
			filePathOutPiece = Config.piecePath;
